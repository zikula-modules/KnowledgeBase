...
use Guite\KnowledgeBaseModule\Listener\Base\UserLoginListener as BaseUserLoginListener;
...
class UserLoginListener extends BaseUserLoginListener
{
     ...
     */
    public static function started(GenericEvent $event)
    {
     ...
     * @param GenericEvent $event The event instance.
     */
    public static function veto(GenericEvent $event)
    {
        parent::veto($event);
    }
     ...
     * @param GenericEvent $event The event instance.
     */
    public static function failed(GenericEvent $event)
    {
        parent::failed($event);
    }
