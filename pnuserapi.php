 ...
 */
function KnowledgeBase_userapi_getCategories($args)
{
 ...
 */
function KnowledgeBase_userapi_getTickets($args)
{
...
// DEBUG: permission check aspect ends
    ...
    $class = Loader::loadArrayClassFromModule('KnowledgeBase', $objectType);
 ...
 * @return       Render output
 */
function KnowledgeBase_userapi_getTicket($args)
{
 ...
 */
function KnowledgeBase_userapi_encodeurl($args)
{
 ...
 */
function KnowledgeBase_userapi_decodeurl($args)
{
    $dom = ZLanguage::getModuleDomain('KnowledgeBase');
