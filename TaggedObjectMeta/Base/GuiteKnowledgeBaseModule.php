...
namespace Guite\KnowledgeBaseModule\TaggedObjectMeta\Base;
 ...
 */
class GuiteKnowledgeBaseModule extends \Tag\AbstractTaggedObjectMeta
{
    /**
     * Constructor.
     *
     ...
     * @param ModUrl $urlObject Object carrying url arguments.
     */
    function __construct($objectId, $areaId, $module, $urlString = null, ModUrl $urlObject = null)
    {
        ...
        $objectType = isset($urlArgs['ot']) ? $urlArgs['ot'] : 'ticket';
