...
/**
 * The guiteknowledgebasemoduleFormFrame plugin adds styling <div> elements and a validation summary.
 *
 ...
 */
function smarty_block_guiteknowledgebasemoduleFormFrame($params, $content, $view)
{
    ...
    $result .= $view->registerBlock('\\Guite\\KnowledgeBaseModule\\Form\\Plugin\\FormFrame', $params, $content);
