...
use Guite\KnowledgeBaseModule\RouterFacade;
...
class UserApi extends Zikula_AbstractApi
{
    ...
    public function getlinks()
    {
        ...
        if (SecurityUtil::checkPermission($this->name . '::', '::', ACCESS_ADMIN)) {
            $links[] = array('url' => ModUtil::url($this->name, 'admin', 'index'),
        ...
        if (in_array('ticket', $allowedObjectTypes)
            && SecurityUtil::checkPermission($this->name . ':Ticket:', '::', ACCESS_READ)) {
    ...
    public function encodeurl(array $args = array())
    {
        ...
        $modInfo = ModUtil::getInfoFromName('GuiteKnowledgeBaseModule');
