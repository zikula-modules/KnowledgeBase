...
class KnowledgeBase_Api_Base_User extends Zikula_Api
{
    ...
    public function getlinks()
    {
        ...
        if (SecurityUtil::checkPermission('KnowledgeBase::', '::', ACCESS_READ)) {
            $links[] = array('url'   => ModUtil::url('KnowledgeBase', 'user', 'view', array('ot' => 'ticket')),
    ...
    public function encodeurl($args)
    {
        ...
        $routerFacade = new KnowledgeBase_RouterFacade();
        ...
        $allowedObjectTypes = KnowledgeBase_Util_Controller::getObjectTypes('api', $utilArgs);
        $objectType = ((isset($args['args']['ot']) && in_array($args['args']['ot'], $allowedObjectTypes)) ? $args['args']['ot'] : KnowledgeBase_Util_Controller::getDefaultObjectType('api', $utilArgs));
        ...
        foreach (array('csv', 'rss', 'atom', 'xml', 'pdf') as $ending) {
    ...
    public function decodeurl($args)
    {
        ...
        $lang = ($args['vars'][0] == 'KnowledgeBase') ? $args['vars'][1] : $args['vars'][0];
        ...
        if (isset($parameters[$func . 'ending']) && $parameters[$func . 'ending'] != ($endingPrefix . $displayDefaultEnding)) {
            if ($func == 'view') {
