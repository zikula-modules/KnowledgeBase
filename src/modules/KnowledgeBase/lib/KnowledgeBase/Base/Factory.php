...
class KnowledgeBase_Base_Factory
{
    ...
    public static function getBusinessObjectCommon($useCollection = false, $objectType = 'ticket', $context = '', $args = array())
    {
        ...
        if (!in_array($objectType, KnowledgeBase_Util_Controller::getObjectTypes($context, $args))) {
            $objectType = KnowledgeBase_Util_Controller::getDefaultObjectType($context, $args);
        }
     ...
     */
    public static function getBusinessEntity($objectType = 'ticket', $context = '', $args = array())
    {
