 ...
 */
class KnowledgeBase_ContentType_Base_ItemList extends Content_AbstractContentType
{
    private $objectType;
    private $sorting;
    private $amount;
    ...
    {
        if (!isset($data['objectType']) || !in_array($data['objectType'], KnowledgeBase_Util_Controller::getObjectTypes('contentType'))) {
    ...
    public function display()
    {
        ...
        $repository = $entityManager->getRepository('KnowledgeBase_Entity_' . ucfirst($this->objectType));
    ...
    {
        $dom = ZLanguage::getModuleDomain('KnowledgeBase');
        array_push($this->view->plugins_dir, 'modules/KnowledgeBase/templates/plugins');
    }
}
