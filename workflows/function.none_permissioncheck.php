 ...
 */
function GuiteKnowledgeBaseModule_workflow_none_permissioncheck($obj, $permLevel, $currentUser, $actionId)
{
    ...
    $idFields = ModUtil::apiFunc('GuiteKnowledgeBaseModule', 'selection', 'getIdFields', array('ot' => $objectType));
    $instanceId = '';
 ...
 */
function GuiteKnowledgeBaseModule_workflow_none_gettextstrings()
{
    return array(
