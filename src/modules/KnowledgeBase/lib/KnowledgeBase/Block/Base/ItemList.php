 ...
 */
class KnowledgeBase_Block_Base_ItemList extends Zikula_Block
{
    /**
    ...
    public function display($blockinfo)
    {
        ...
        if (!isset($vars['objectType']) || !in_array($vars['objectType'], KnowledgeBase_Util::getObjectTypes('block'))) {
            $vars['objectType'] = 'ticket';
        }
    ...
    public function update($blockinfo)
    {
        ...
        $vars['objectType'] = FormUtil::getPassedValue('objecttype', 'ticket', 'POST');
        ...
        if (!in_array($vars['objectType'], KnowledgeBase_Util::getObjectTypesBlock())) {
            $vars['objectType'] = 'ticket';
        }
