...
class KnowledgeBase_Api_User extends KnowledgeBase_Api_Base_User
{
    ...
    public function getCategories($args)
    {
        ...
        foreach ($categories as $k => $cat) {
            ...
            if (!isset($args['skipticketassignment'])) {
                list($objectData, $objcount) = ModUtil::apiFunc($this->name, 'user', 'getTickets', array('category' => $cat['id'], 'term' => ''));
    ...
    // DEBUG: permission check aspect ends
        ...
        // category filters
        $category = ((isset($args['category']) ? $args['category'] : $this->request->getGet()->filter('cat', 0, FILTER_VALIDATE_INT)));
        if ($category > 0) {
