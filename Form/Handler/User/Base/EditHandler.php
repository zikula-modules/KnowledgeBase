...
namespace Guite\KnowledgeBaseModule\Form\Handler\User\Base;

use Guite\KnowledgeBaseModule\Form\Plugin\AbstractObjectSelector;
...
class EditHandler extends Zikula_Form_AbstractHandler
{
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        $controllerHelper = new ControllerUtil($this->view->getServiceManager(), ModUtil::getModule($this->name));
    ...
    protected function initEntityForEdit()
    {
        ...
        if ($entity == null) {
            throw new \RuntimeException($this->__('No such item.'));
        }
    ...
    protected function initEntityForCreation()
    {
        ...
        if ($this->hasTemplateId === true) {
            ...
            $entityClass = 'Guite\\KnowledgeBaseModule\\Entity\\' . ucwords($this->objectType) . 'Entity';
    ...
    public function handleCommand(Zikula_Form_View $view, &$args)
    {
        ...
        if ($action != 'cancel') {
            ...
            if ($action != 'delete') {
                ...
                $url = new ModUrl($this->name, 'user', 'display', ZLanguage::getLanguageCode(), $urlArgs);
            }
