...
/**
 * The guiteknowledgebasemoduleTemplateSelector plugin provides items for a dropdown selector.
 *
 ...
 */
function smarty_function_guiteknowledgebasemoduleTemplateSelector($params, $view)
{
