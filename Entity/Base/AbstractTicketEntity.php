 ...
 * @abstract
 */
abstract class AbstractTicketEntity extends Zikula_EntityAccess
{
    /**
    ...
    /**
     * @var \Guite\KnowledgeBaseModule\Entity\Validator\TicketValidator The validator for this entity.
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity="\Guite\KnowledgeBaseModule\Entity\TicketCategoryEntity", 
     *                mappedBy="entity", cascade={"all"}, 
     *                orphanRemoval=true)
     * @var \Guite\KnowledgeBaseModule\Entity\TicketCategoryEntity
     */
     ...
     * Get _validator.
     *
     * @return \Guite\KnowledgeBaseModule\Entity\Validator\TicketValidator
     */
     ...
     * Set _validator.
     *
     * @param \Guite\KnowledgeBaseModule\Entity\Validator\TicketValidator $_validator.
     *
     * @return void
     */
    public function set_validator(\Guite\KnowledgeBaseModule\Entity\Validator\TicketValidator $_validator = null)
    {
     ...
     *
     * @return \Guite\KnowledgeBaseModule\Entity\Validator\TicketValidator The validator for this entity.
     */
    public function initValidator()
    {
        ...
        $this->_validator = new \Guite\KnowledgeBaseModule\Entity\Validator\TicketValidator($this);
    ...
    public function initWorkflow($forceLoading = false)
    {
        ...
        $idColumn = 'id';
        $workflowHelper = new WorkflowUtil(ServiceUtil::getManager(), ModUtil::getModule('GuiteKnowledgeBaseModule'));
        ...
        if ((!in_array($currentFunc, array('index', 'view', 'display')) && empty($isReuse)) || $forceLoading) {
            $result = Zikula_Workflow_Util::getWorkflowForObject($this, $this['_objectType'], $idColumn, 'GuiteKnowledgeBaseModule');
            if (!$result) {
    ...
    protected function prepareItemActions()
    {
        ...
        if ($currentType == 'user') {
            ...
            if (in_array($currentFunc, array('index', 'view', 'display'))) {
                $component = 'GuiteKnowledgeBaseModule:Ticket:';
                $instance = $this->id . '::';
    ...
    {
        return 'knowledgebase.ui_hooks.tickets';
    }
     ...
     *
     * @see Guite\KnowledgeBaseModule\Entity\TicketEntity::postLoadCallback()
    ...
    protected function performPostLoadCallback()
    {
        ...
        $this->formatTextualField('subject', $currentFunc, $usesCsvOutput);
        $this->formatTextualField('content', $currentFunc, $usesCsvOutput);
     ...
     *
     * @see Guite\KnowledgeBaseModule\Entity\TicketEntity::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see Guite\KnowledgeBaseModule\Entity\TicketEntity::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see Guite\KnowledgeBaseModule\Entity\TicketEntity::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     *
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see Guite\KnowledgeBaseModule\Entity\TicketEntity::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no creation of other entities allowed
     *
     * @see Guite\KnowledgeBaseModule\Entity\TicketEntity::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see Guite\KnowledgeBaseModule\Entity\TicketEntity::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see Guite\KnowledgeBaseModule\Entity\TicketEntity::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see Guite\KnowledgeBaseModule\Entity\TicketEntity::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
