...
// DEBUG: permission check aspect ends
        ...
        if (!in_array($objectType, KnowledgeBase_Util::getObjectTypes('controllerAction', array('controller' => 'user', 'action' => 'View')))) {
            $objectType = KnowledgeBase_Util::getDefaultObjectType('controllerAction', array('controller' => 'user', 'action' => 'View'));
        }
        ...
        return KnowledgeBase_Util::processViewTemplate($this->view, 'user', $objectType, 'view', $args);
    }
...
// DEBUG: permission check aspect ends
        ...
        // parameter specifying which type of objects we are treating
        $objectType = FormUtil::getPassedValue('ot', 'ticket', 'GET');
        if (!in_array($objectType, KnowledgeBase_Util::getObjectTypes('controllerAction', array('controller' => 'user', 'action' => 'Display')))) {
            $objectType = KnowledgeBase_Util::getDefaultObjectType('controllerAction', array('controller' => 'user', 'action' => 'Display'));
        }
        ...
        if (!$id) {
            ...
            if ($hasSlug) {
                $slugTitle = FormUtil::getPassedValue('title', isset($args['title']) && !empty($args['title']) ? $args['title'] : '', 'GET');
        ...
        // fetch and return the appropriate template
        return KnowledgeBase_Util::processViewTemplate($this->view, 'user', $objectType, 'display', $args);
    }
...
// DEBUG: permission check aspect ends
        ...
        // parameter specifying which type of objects we are treating
        $objectType = FormUtil::getPassedValue('ot', 'ticket', 'GET');
        if (!in_array($objectType, KnowledgeBase_Util::getObjectTypes('controllerAction', array('controller' => 'user', 'action' => 'Edit')))) {
            $objectType = KnowledgeBase_Util::getDefaultObjectType('controllerAction', array('controller' => 'user', 'action' => 'Edit'));
        }
...
// DEBUG: permission check aspect ends
        ...
        // parameter specifying which type of objects we are treating
        $objectType = FormUtil::getPassedValue('ot', 'ticket', 'GET');
        if (!in_array($objectType, KnowledgeBase_Util::getObjectTypes('controllerAction', array('controller' => 'user', 'action' => 'Assign')))) {
            $objectType = KnowledgeBase_Util::getDefaultObjectType('controllerAction', array('controller' => 'user', 'action' => 'Assign'));
        }
        /** TODO: custom logic */
    }
