 ...
 */
class KnowledgeBase_Form_Handler_User_Base_Edit extends Zikula_Form_AbstractHandler
{
    /**
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        $this->idValues = KnowledgeBase_Util_Controller::retrieveIdentifier($this->request, array(), $this->objectType, $this->idFields);
        $hasIdentifier = KnowledgeBase_Util_Controller::isValidIdentifier($this->idValues);
    ...
    public function HandleCommand(Zikula_Form_View $view, &$args)
    {
        ...
        $hookAreaPrefix = 'knowledgebase.ui_hooks.' . $this->objectTypeLowerMultiple;
