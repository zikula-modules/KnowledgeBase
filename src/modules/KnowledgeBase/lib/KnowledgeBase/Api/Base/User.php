...
class KnowledgeBase_Api_Base_User extends Zikula_Api
{
    ...
    public function encodeurl($args)
    {
        ...
        $allowedObjectTypes = KnowledgeBase_Util::getObjectTypes('api', array('controller' => 'user', 'action' => 'encodeurl'));
        $objectType = ((isset($args['args']['ot']) && in_array($args['args']['ot'], $allowedObjectTypes)) ? $args['args']['ot'] : 'ticket');
