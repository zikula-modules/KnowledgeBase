...
/**
 * The guiteknowledgebasemoduleValidationError plugin returns appropriate (and multilingual)
 ...
 */
function smarty_function_guiteknowledgebasemoduleValidationError($params, $view)
{
    $id = $params['id'];
    $class = $params['class'];
